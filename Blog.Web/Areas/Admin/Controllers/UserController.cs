...
namespace Blog.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(IValidator<AppUser> validator, IToastNotification toast, IMapper mapper, IUserService userService)
        {
        ...
        public async Task<IActionResult> Profile(UserProfileDto userProfileDto)
        {
            ...
            {
                toast.AddErrorToastMessage("Profil güncelleme işlemi başarısız oldu.", new ToastrOptions { Title = "İşlem Başarısız" });
                return NotFound();
            }
        }
    }
