...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20240523171446_article_detail1")]
    partial class article_detail1
    {
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "78eba75f-28b4-4bef-a3a5-0fa982297a6e",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b4bf4287-f60d-46c8-84cc-7a5f49173d1c",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "40add177-1f3d-4508-958e-7f6a0b337d8b",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4f93c65d-50d7-4a34-a9bc-6e1bec11375b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPmp3rsls/VGhI+55ZcY1sB8/IJIHYTJkw+DrYliCq+5YDqKtV5PRl+xeXkX+ZuagQ==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f2360f75-c4c1-4c2a-913d-e849e0f86cfc",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "89b19458-9391-4cc1-b25a-b3a89847f3bf",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEELqmB2HUZibs9DFuMszfnZVebG3b9umqZ/xx0EWzJ5ggaBBeI08MLdPJnqLKATETw==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1de62118-1cf3-4428-b1a0-a2df0adc24bd",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6e50c278-8a7d-42ac-8ea1-f5bf77d7c247"),
                            ...
                            CreatedDate = new DateTime(2024, 5, 23, 20, 14, 45, 567, DateTimeKind.Local).AddTicks(5397),
                            ImageId = new Guid("ab93efd7-1144-4343-b7a9-ed3de38a597d"),
                        ...
                        new
                        {
                            Id = new Guid("9628a2be-e7eb-4712-a451-67e24e91aab5"),
                            CategoryId = new Guid("46d6d928-e1f3-4a16-9557-53e5941ce64a"),
                            Content = "Visual Studio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vel tellus consequat, semper ex a, dictum enim. Maecenas tortor velit, placerat et aliquam id, scelerisque vel risus. Etiam varius justo quis rhoncus condimentum. Ut dignissim lacus at orci mollis blandit. Maecenas tempor neque purus, a imperdiet justo elementum vel. Duis in bibendum ligula. Phasellus eu ornare mauris, ut vestibulum neque. Cras placerat massa et ultricies venenatis. Fusce vestibulum ipsum quis nunc dictum dignissim. Suspendisse non turpis id enim euismod pretium eget vitae ipsum. Donec tempor ullamcorper eros, convallis pretium risus. Vestibulum lobortis eu ligula sed lacinia. Praesent nec feugiat ligula, et egestas arcu. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 23, 20, 14, 45, 567, DateTimeKind.Local).AddTicks(5404),
                            ImageId = new Guid("0ad8eaca-f38a-447b-b21c-89ac3ea4c72a"),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 23, 20, 14, 45, 567, DateTimeKind.Local).AddTicks(6306),
                            Name = "ASP.NET Core",
                            isDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 23, 20, 14, 45, 567, DateTimeKind.Local).AddTicks(6309),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 23, 20, 14, 45, 567, DateTimeKind.Local).AddTicks(6377),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 23, 20, 14, 45, 567, DateTimeKind.Local).AddTicks(6380),
