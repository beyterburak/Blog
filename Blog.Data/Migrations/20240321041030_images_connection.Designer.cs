...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20240321041030_images_connection")]
    partial class images_connection
    {
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0de0f374-9e66-45c3-841d-c1d7879c8a66",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "07085508-376d-4370-b7ab-d59abe6a28ee",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9577279f-012d-4aac-9a46-023d1ca2acf1",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "49a435a2-0734-4799-b2cd-66a203bbbf09",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHAU/9r+OiJ+e9gFukU2uiivmW+9oloSCjLDKrMwYzPUu6JUsC4TzpyHMF4JfAtWTA==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "2a695fae-1dc8-4d05-ba41-fbad0a943b53",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a7b9ac43-6656-4ba7-86f0-0541baa7a2c5",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGcl+vvvL1n0hi9PmN5kzr3I7IIQFdonhCqpe1+tKvXw/ozSGm+llepg/H9We9BLww==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "84d90d13-c265-45df-bb69-1cd8ff4363c9",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("36a7d77e-a01d-48df-aae5-daa71da49a65"),
                            ...
                            CreatedDate = new DateTime(2024, 3, 21, 7, 10, 29, 807, DateTimeKind.Local).AddTicks(1629),
                            ImageId = new Guid("ab93efd7-1144-4343-b7a9-ed3de38a597d"),
                        ...
                        new
                        {
                            Id = new Guid("34ef89da-2445-48bc-aa89-8e1eb90d556f"),
                            CategoryId = new Guid("46d6d928-e1f3-4a16-9557-53e5941ce64a"),
                            Content = "Visual Studio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vel tellus consequat, semper ex a, dictum enim. Maecenas tortor velit, placerat et aliquam id, scelerisque vel risus. Etiam varius justo quis rhoncus condimentum. Ut dignissim lacus at orci mollis blandit. Maecenas tempor neque purus, a imperdiet justo elementum vel. Duis in bibendum ligula. Phasellus eu ornare mauris, ut vestibulum neque. Cras placerat massa et ultricies venenatis. Fusce vestibulum ipsum quis nunc dictum dignissim. Suspendisse non turpis id enim euismod pretium eget vitae ipsum. Donec tempor ullamcorper eros, convallis pretium risus. Vestibulum lobortis eu ligula sed lacinia. Praesent nec feugiat ligula, et egestas arcu. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 21, 7, 10, 29, 807, DateTimeKind.Local).AddTicks(1644),
                            ImageId = new Guid("0ad8eaca-f38a-447b-b21c-89ac3ea4c72a"),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 21, 7, 10, 29, 807, DateTimeKind.Local).AddTicks(1797),
                            Name = "ASP.NET Core",
                            isDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 21, 7, 10, 29, 807, DateTimeKind.Local).AddTicks(1801),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 21, 7, 10, 29, 807, DateTimeKind.Local).AddTicks(1865),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 21, 7, 10, 29, 807, DateTimeKind.Local).AddTicks(1867),
