...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20240405111134_Visitor")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a63fbe98-0623-4538-8552-cc5eeaf524e9",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9a0f41f6-ef78-4747-971e-d5edaeb66962",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "106b15d8-4eb8-482d-b188-4219220f1f2c",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3c13fed7-e2f0-44a1-91a8-287db2bf7416",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJF67CGzcUySZiLJ0vSI7fFzeIxzkUeAEhNnWBpbfubQRHqzyWHKtnn/0R+L7z2RLw==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "ee354c9b-c72d-4523-85bc-fb57b3ee70ad",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e798e8c0-54d9-46dd-b3cd-17b49a81d580",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOugKqY2BTG0J4YKCV6rQKIA4MhRpg6A1uxmsX9TQ5eXC18yYOFrJjED5BvNG78G4g==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "08b45864-6b89-48f6-8e5a-ea31e097adc4",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e00eb70a-8a5a-45a9-80f8-d572f1e33f3b"),
                            ...
                            CreatedDate = new DateTime(2024, 4, 5, 14, 11, 33, 769, DateTimeKind.Local).AddTicks(290),
                            ImageId = new Guid("ab93efd7-1144-4343-b7a9-ed3de38a597d"),
                        ...
                        new
                        {
                            Id = new Guid("9514cfed-2878-4708-9b51-10c7b6497519"),
                            CategoryId = new Guid("46d6d928-e1f3-4a16-9557-53e5941ce64a"),
                            Content = "Visual Studio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vel tellus consequat, semper ex a, dictum enim. Maecenas tortor velit, placerat et aliquam id, scelerisque vel risus. Etiam varius justo quis rhoncus condimentum. Ut dignissim lacus at orci mollis blandit. Maecenas tempor neque purus, a imperdiet justo elementum vel. Duis in bibendum ligula. Phasellus eu ornare mauris, ut vestibulum neque. Cras placerat massa et ultricies venenatis. Fusce vestibulum ipsum quis nunc dictum dignissim. Suspendisse non turpis id enim euismod pretium eget vitae ipsum. Donec tempor ullamcorper eros, convallis pretium risus. Vestibulum lobortis eu ligula sed lacinia. Praesent nec feugiat ligula, et egestas arcu. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 5, 14, 11, 33, 769, DateTimeKind.Local).AddTicks(302),
                            ImageId = new Guid("0ad8eaca-f38a-447b-b21c-89ac3ea4c72a"),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 5, 14, 11, 33, 769, DateTimeKind.Local).AddTicks(2933),
                            Name = "ASP.NET Core",
                            isDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 5, 14, 11, 33, 769, DateTimeKind.Local).AddTicks(2938),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 5, 14, 11, 33, 769, DateTimeKind.Local).AddTicks(3207),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 4, 5, 14, 11, 33, 769, DateTimeKind.Local).AddTicks(3211),
