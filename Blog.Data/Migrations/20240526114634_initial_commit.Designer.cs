...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20240526114634_initial_commit")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "4ad0a826-0cee-4aac-be40-f33dbacaa2f0",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2a610f78-eccb-41ee-a24a-ef1da16e16cb",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8e9e4349-5b6e-415e-9ee2-68aea63ff2c1",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "64eef1ea-6993-4917-bfd7-32379b22957a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOK1M7Y/26ttYDbsDq6mckU4t7uh8U8NcJjnLUOtrTR4YHoBHM9xmxXF/ZYF0ROZ7w==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "56334338-cd26-43a0-9c44-08f157fd1b1e",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f9f8b201-8226-47c4-b9be-903ddd637681",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMkGwPBoxZfFWZCJVB4/Jz4L8G+JXSCSb6xe2mDuLK/m80Xrz31SMiWzaRjB4GeL1Q==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "68417df5-253f-4d5e-9957-c76cd43e3a1d",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a6c2ef45-f5f2-4cbc-a0dc-3f0ef7edc706"),
                            ...
                            CreatedDate = new DateTime(2024, 5, 26, 14, 46, 33, 779, DateTimeKind.Local).AddTicks(1221),
                            ImageId = new Guid("ab93efd7-1144-4343-b7a9-ed3de38a597d"),
                        ...
                        new
                        {
                            Id = new Guid("d548b2e9-12a4-4463-8de4-8b03d91471fd"),
                            CategoryId = new Guid("46d6d928-e1f3-4a16-9557-53e5941ce64a"),
                            Content = "Visual Studio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vel tellus consequat, semper ex a, dictum enim. Maecenas tortor velit, placerat et aliquam id, scelerisque vel risus. Etiam varius justo quis rhoncus condimentum. Ut dignissim lacus at orci mollis blandit. Maecenas tempor neque purus, a imperdiet justo elementum vel. Duis in bibendum ligula. Phasellus eu ornare mauris, ut vestibulum neque. Cras placerat massa et ultricies venenatis. Fusce vestibulum ipsum quis nunc dictum dignissim. Suspendisse non turpis id enim euismod pretium eget vitae ipsum. Donec tempor ullamcorper eros, convallis pretium risus. Vestibulum lobortis eu ligula sed lacinia. Praesent nec feugiat ligula, et egestas arcu. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 26, 14, 46, 33, 779, DateTimeKind.Local).AddTicks(1229),
                            ImageId = new Guid("0ad8eaca-f38a-447b-b21c-89ac3ea4c72a"),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 26, 14, 46, 33, 779, DateTimeKind.Local).AddTicks(2178),
                            Name = "ASP.NET Core",
                            isDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 26, 14, 46, 33, 779, DateTimeKind.Local).AddTicks(2180),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 26, 14, 46, 33, 779, DateTimeKind.Local).AddTicks(2258),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 26, 14, 46, 33, 779, DateTimeKind.Local).AddTicks(2274),
