...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20240529194628_add_comment")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f198ff48-0df8-4acb-9cac-c1d2537d925a",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f62a999f-0836-4868-9eac-60d3a1560ab8",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a6bbebab-6248-46ce-8595-7de2a3f3e899",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9a48466f-3f83-4070-833e-55eefea62075",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEM7f8MVaaDdViat4TmSzU/TzRzFMyI3Gs29mhIJd8GR06U6t27PMBFJOc+RasTyjKg==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "c0687892-9135-4218-9477-8d2e1422e5b4",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c7559589-6229-4705-9404-5aa345ef7f42",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEArzuOHiNkCdfy37aFsyzedqhB0fhshC3FY4lYWyXiZhtG+ai7Dt4s2485DM5BLNiQ==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "98faa1a1-e0d1-4813-ba4b-3c9ad914801b",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5c9468d8-f6f5-43d8-971b-c6d7f444cd73"),
                            ...
                            CreatedDate = new DateTime(2024, 5, 29, 22, 46, 28, 24, DateTimeKind.Local).AddTicks(8290),
                            ImageId = new Guid("ab93efd7-1144-4343-b7a9-ed3de38a597d"),
                        ...
                        new
                        {
                            Id = new Guid("fe348889-ee5f-4b20-8c46-491b376f106e"),
                            CategoryId = new Guid("46d6d928-e1f3-4a16-9557-53e5941ce64a"),
                            Content = "Visual Studio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vel tellus consequat, semper ex a, dictum enim. Maecenas tortor velit, placerat et aliquam id, scelerisque vel risus. Etiam varius justo quis rhoncus condimentum. Ut dignissim lacus at orci mollis blandit. Maecenas tempor neque purus, a imperdiet justo elementum vel. Duis in bibendum ligula. Phasellus eu ornare mauris, ut vestibulum neque. Cras placerat massa et ultricies venenatis. Fusce vestibulum ipsum quis nunc dictum dignissim. Suspendisse non turpis id enim euismod pretium eget vitae ipsum. Donec tempor ullamcorper eros, convallis pretium risus. Vestibulum lobortis eu ligula sed lacinia. Praesent nec feugiat ligula, et egestas arcu. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 29, 22, 46, 28, 24, DateTimeKind.Local).AddTicks(8296),
                            ImageId = new Guid("0ad8eaca-f38a-447b-b21c-89ac3ea4c72a"),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 29, 22, 46, 28, 24, DateTimeKind.Local).AddTicks(8987),
                            Name = "ASP.NET Core",
                            isDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 29, 22, 46, 28, 24, DateTimeKind.Local).AddTicks(8989),
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 29, 22, 46, 28, 24, DateTimeKind.Local).AddTicks(9056),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 29, 22, 46, 28, 24, DateTimeKind.Local).AddTicks(9069),
